...
<div class="w-full pt-20 pl-4 sm:pl-8 md:pl-14 lg:pl-20 pr-4 sm:pr-8 lg:pr-20">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">Temukan informasi kontak dan lokasi Ez Coliving untuk kebutuhan hunian Anda.</p>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-16">
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="rounded-lg overflow-hidden shadow-lg h-[400px]">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.8679400817785!2d106.82201361476894!3d-6.147530995551365!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5cae6eda631%3A0xb6a64117a10a69d!2sJl.%20Mangga%20Besar%204F%20No.5%2C%20RT.1%2FRW.2%2C%20Mangga%20Besar%2C%20Kecamatan%20Taman%20Sari%2C%20Kota%20Jakarta%20Barat%2C%20Daerah%20Khusus%20Ibukota%20Jakarta%2011150!5e0!3m2!1sid!2sid!4v1651321050983!5m2!1sid!2sid" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <form class="space-y-6 max-w-4xl mx-auto">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="subject" class="block text-sm font-medium text-gray-700 mb-1">Subjek</label>
                        <input type="text" id="subject" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                    ...
                    <div class="flex justify-center">
                        <button type="submit" class="px-6 py-3 bg-green-600 text-white font-medium rounded-md hover:bg-green-700 transition-colors">Kirim Pesan</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="space-y-4">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="hidden px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">Anda dapat memesan kamar dengan mengunjungi halaman Kamar kami, memilih kamar yang tersedia, dan mengikuti proses checkout. Atau Anda dapat menghubungi kami langsung via WhatsApp untuk bantuan pemesanan.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="hidden px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">Minimal masa tinggal adalah 1 bulan. Namun, kami menawarkan diskon khusus untuk pemesanan dengan durasi lebih panjang.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="hidden px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">Ya, kami menyediakan opsi pembayaran cicilan untuk tenant dengan durasi tinggal minimal 3 bulan. Silakan hubungi admin kami untuk informasi lebih lanjut.</p>
                    </div>
                </div>
                
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <button class="flex justify-between items-center w-full px-6 py-4 text-left" onclick="toggleFaq(this)">
                        <span class="font-semibold text-gray-800">Fasilitas apa saja yang tersedia di Ez Coliving?</span>
                        <svg class="h-5 w-5 text-gray-500 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div class="hidden px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">Ez Coliving menyediakan berbagai fasilitas seperti WiFi kecepatan tinggi, ruang komunal, dapur bersama, laundry, keamanan 24 jam, dan pembersihan area umum rutin.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-10 row-gap-6 mb-8 xsm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="space-y-2 text-sm">
                ...
                <div class="flex">
                    ...
                    <a href="mailto:ezcoliving@gmail.com" class="text-gray-600 hover:text-green-700">ezcoliving@gmail.com</a>
                </div>
                <div class="flex">

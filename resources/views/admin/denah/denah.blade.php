...
@section('content')
                    ...
                    <div class="relative  mx-auto h-full">
                        ...
                        <div class="absolute inset-0">
                            ...
                            <div class="absolute flex flex-wrap" style="top: 20.5%; left: 2%; width: 96%; height: 38%;">
                                <div
                                    class="bg-gray-400 rounded-lg flex items-center justify-center p-2 w-[74px] h-[135px] mr-4">
                                    <span class="text-white text-base text-center">Rak paket</span>
                                </div>
                                <div class="room-item bg-gray-100 border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer w-[150px] h-[135px] mr-4"
                                    data-room="1BE">
                            ...
                            <div class="absolute flex flex-wrap" style="bottom: 2%; left: 2%; width: 96%; height: 38%;">
                                <div
                                    class="room-item bg-gray-100 border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer w-[148px] h-[135px] mr-4">
                                ...
                                <div
                                    class="bg-gray-400 rounded-lg flex items-center justify-center p-2 w-[112px] h-[135px] mr-4">
                                    <span class="text-white text-base">Gudang</span>
                                </div>
                                <div
                                    class="bg-gray-400 rounded-lg flex items-center justify-center p-2 w-[92px] h-[135px] mr-4">
                                    <span class="text-white text-base">Stair</span>
                                </div>
                                <div class="room-item bg-gray-100 border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer w-[160px] h-[135px] mr-4"
                                    data-room="1AB">
            ...
            <div class="floor-content hidden" data-floor="2">
                ...
                <div class="absolute inset-0 p-4">
                    ...
                    <div class="absolute flex flex-wrap" style="top: 20.5%; left: 2%; width: 96%; height: 38%;">
                        ...
                        <div class="room-item bg-gray-100 border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer w-[186px] h-[135px]"
                            data-room="2BA">
                    ...
                    <div class="absolute flex flex-wrap" style="bottom: 2%; left: 2%; width: 96%; height: 38%;">
                        <div
                            class="bg-gray-400 col-span-2 rounded-lg flex items-center justify-center p-2 w-[380px] h-[135px] mr-4">
            ...
            <div class="floor-content hidden" data-floor="3">
                <div class="absolute inset-0 p-4">
                    ...
                    <div class="absolute flex flex-wrap" style="top: 20.5%; left: 2%; width: 96%; height: 38%;">
                        ...
                        <div class="room-item bg-gray-100 border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer w-[186px] h-[135px] mr-4"
                            data-room="3BA">
                    ...
                    <!-- Kamar Bawah -->
                    <div class="absolute flex flex-wrap" style="bottom: 2%; left: 2%; width: 96%; height: 38%;">
                        <div class="room-item bg-gray-100 border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer w-[170px] h-[135px] mr-4"
                            data-room="3AE">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const denahContainer = document.querySelector('.bg-gray-800');
            ...
            floorButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    // Update container width for floor 1
                    if (floor === '1') {
                        denahContainer.style.width = '90%';
                        denahContainer.style.margin = '0 auto';
                    } else {
                        denahContainer.style.width = '100%';
                        denahContainer.style.margin = '0';
                    }
                });
            });

            // Set initial width for floor 1
            denahContainer.style.width = '90%';
            denahContainer.style.margin = '0 auto';
